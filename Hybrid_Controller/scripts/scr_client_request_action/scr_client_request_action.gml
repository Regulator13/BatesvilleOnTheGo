...
function client_request_action(action, buff, length) {
	...
	buffer_write(buff, buffer_u8, obj_hybrid_client.connect_id)
	//write msg_id
	buffer_write(buff, buffer_s8, HYBRID_CLIENT_PLAY)
	...
	obj_hybrid_client.log_message(string("-> TCP ACTION {0}", scr_action_to_string(action)))
