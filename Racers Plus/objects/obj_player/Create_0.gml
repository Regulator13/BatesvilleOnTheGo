...
model_turn_speeds = [8, 3, 4, 3, 2, 2.5, 1.5, 1.5, 2.5, 1] //How many degrees the car turns each step
model_accels = [.06, .25, .3, .2, .15, .1, .15, .2, .05] //How fast the car speeds up
...
model_gear_max_speeds = [[-1, 1, 1.5, 3], [-4, 3, 6, 9, 12, 16], [-2, 2, 4, 7, 10, 15, 22], [-3, 2, 4, 7, 10], [-2, 2, 4, 9], [-2, 2, 4, 6, 9, 12], [-3, 3, 6, 9, 14], [-2, 2, 4, 6, 9], [-.5, 1.5, 3, 5, 8, 12]]
model_gear_min_speeds = [[0, 0, 0.5, 1], [0, 0, 2, 5, 8, 11], [0, 0, 1, 3, 6, 9, 14], [0, 0, 1, 3, 6], [0, 0, 1, 3], [0, 0, 1, 3, 5, 8], [0, 0, 2, 5, 8], [0, 0, 1, 3, 5], [0, 0, 1, 2, 4, 7]]
